...
BlueConfPP::BlueConfPP(QMap<QString, BluetoothItem *> *devices, QObject *parent) :
    QObject(parent)
{
...
BlueConfPP::~BlueConfPP()
{
    ...
    while (!records.isEmpty()) {
        QPair<QString, QMap<QString, BluetoothItem *> *> r = records.takeFirst();
    ...
    if (rList) {
        ...
        while (r) {
            if (!name.compare(r->username)) {
                ...
                records.append(QPair<QString, QMap<QString, BluetoothItem *> *>
                               (QString(r->username), new QMap<QString, BluetoothItem *>()));
            }
